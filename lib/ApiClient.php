...
class ApiClient
{
     ...
     * @throws \ProfitBricks\Client\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers)) {
            ...
            $postData = json_encode(\ProfitBricks\Client\ObjectSerializer::sanitizeForSerialization($postData));
        }
