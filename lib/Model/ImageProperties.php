 ...
 */
class ImageProperties implements ArrayAccess
{
    /**
    ...
    /**
      * $image_type This indicates the type of image
      * @var string
      */
    ...
    /**
     * Sets licence_type
     * @param string $licence_type OS type of this Image
     * @return $this
     */
    public function setLicenceType($licence_type)
    {
        $allowed_values = array("UNKNOWN", "WINDOWS", "LINUX", "OTHER","WINDOWS2016");
        if (!in_array($licence_type, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'licence_type', must be one of 'UNKNOWN', 'WINDOWS', 'LINUX', 'OTHER','WINDOWS2016'");
        }
    ...
    /**
     * Sets image_type
     * @param string $image_type This indicates the type of image
     * @return $this
     */
    public function setImageType($image_type)
    {
        $allowed_values = array("HDD", "CDROM");
        if (!in_array($image_type, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'image_type', must be one of 'HDD', 'CDROM'");
        }
