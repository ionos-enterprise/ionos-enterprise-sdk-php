 ...
 */
class NicEntities implements ArrayAccess
{
    /**
    ...
    static $ProfitBricksTypes = array(
        'firewallrules' => '\ProfitBricks\Client\Model\FirewallRules'
    );
    ...
    /**
      * $firewallrules Collection of firewall rules for that nic
      * @var \ProfitBricks\Client\Model\FirewallRules
      */
    ...
    /**
     * Sets firewallrules
     * @param \ProfitBricks\Client\Model\FirewallRules $firewallrules Collection of firewall rules for that nic
     * @return $this
     */
