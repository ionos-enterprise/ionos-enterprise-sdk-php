...
class RequestStatus implements ArrayAccess
{
    ...
    static $ProfitBricksTypes = array(
        ...
        'type' => 'string',
        'href' => 'string',
        'metadata' => '\ProfitBricks\Client\Model\RequestStatusMetadata'
    );
    ...
    /**
      ...
      * @var \ProfitBricks\Client\Model\RequestStatusMetadata
      */
    protected $metadata;
    ...
    /**
     * Gets metadata
     * @return \ProfitBricks\Client\Model\RequestStatusMetadata
     */
    ...
    /**
     * Sets metadata
     * @param \ProfitBricks\Client\Model\RequestStatusMetadata $metadata Backend managed resource metadata
     * @return $this
     */
