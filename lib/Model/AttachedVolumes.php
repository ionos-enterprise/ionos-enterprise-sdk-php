...
use \ArrayAccess;
/**
 * AttachedVolumes Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     ProfitBricks\Client
 ...
 */
class AttachedVolumes implements ArrayAccess
{
    /**
    ...
    static $ProfitBricksTypes = array(
        ...
        'type' => 'string',
        'href' => 'string',
        'items' => '\ProfitBricks\Client\Model\Volume[]'
    );
    ...
    /**
      ...
      * @var \ProfitBricks\Client\Model\Volume[]
      */
    protected $items;
    ...
    /**
     * Sets items
     * @param \ProfitBricks\Client\Model\Volume[] $items Array of items in that collection
     * @return $this
     */
