 ...
 */
class IpBlocks implements ArrayAccess
{
    /**
    ...
    static $ProfitBricksTypes = array(
        ...
        'type' => 'string',
        'href' => 'string',
        'items' => '\ProfitBricks\Client\Model\IpBlock[]'
    );
    ...
    /**
      ...
      * @var \ProfitBricks\Client\Model\IpBlock[]
      */
    protected $items;
    ...
    /**
     * Sets items
     * @param \ProfitBricks\Client\Model\IpBlock[] $items Array of items in that collection
     * @return $this
     */
