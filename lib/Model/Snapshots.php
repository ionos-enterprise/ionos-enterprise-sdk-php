 ...
 */
class Snapshots implements ArrayAccess
{
    /**
    ...
    static $ProfitBricksTypes = array(
        ...
        'type' => 'string',
        'href' => 'string',
        'items' => '\ProfitBricks\Client\Model\Snapshot[]'
    );
    ...
    /**
      ...
      * @var \ProfitBricks\Client\Model\Snapshot[]
      */
    protected $items;
    ...
    /**
     * Sets items
     * @param \ProfitBricks\Client\Model\Snapshot[] $items Array of items in that collection
     * @return $this
     */
