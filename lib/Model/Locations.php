 ...
 */
class Locations implements ArrayAccess
{
    /**
    ...
    static $ProfitBricksTypes = array(
        ...
        'type' => 'string',
        'href' => 'string',
        'items' => '\ProfitBricks\Client\Model\Location[]'
    );
    ...
    /**
      ...
      * @var \ProfitBricks\Client\Model\Location[]
      */
    protected $items;
    ...
    /**
     * Sets items
     * @param \ProfitBricks\Client\Model\Location[] $items Array of items in that collection
     * @return $this
     */
