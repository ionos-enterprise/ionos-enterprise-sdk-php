...
class Groups implements ArrayAccess
{
    ...
    static $ProfitBricksTypes = array(
        ...
        'type' => 'string',
        'href' => 'string',
        'items' => '\ProfitBricks\Client\Model\GroupItem[]'
    );
    ...
    /**
      ...
      * @var \ProfitBricks\Client\Model\GroupItem[]
      */
    protected $items;
    ...
    /**
     * Sets items
     * @param \ProfitBricks\Client\Model\GroupItem[] $items Array of items in that collection
     * @return $this
     */
