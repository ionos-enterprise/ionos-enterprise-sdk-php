...
class Servers implements ArrayAccess
{
    ...
    static $ProfitBricksTypes = array(
        ...
        'type' => 'string',
        'href' => 'string',
        'items' => '\ProfitBricks\Client\Model\Server[]'
    );
    ...
    /**
      ...
      * @var \ProfitBricks\Client\Model\Server[]
      */
    protected $items;
    ...
    /**
     * Sets items
     * @param \ProfitBricks\Client\Model\Server[] $items Array of items in that collection
     * @return $this
     */
