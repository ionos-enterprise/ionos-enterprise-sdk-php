 ...
 */
class LanEntities implements ArrayAccess
{
    /**
    ...
    static $ProfitBricksTypes = array(
        'nics' => '\ProfitBricks\Client\Model\LanNics'
    );
    ...
    /**
      * $nics Collection of nics attached to this lan
      * @var \ProfitBricks\Client\Model\LanNics
      */
    protected $nics;
    ...
    /**
     * Sets nics
     * @param \ProfitBricks\Client\Model\LanNics $nics Collection of nics attached to this lan
     * @return $this
     */
