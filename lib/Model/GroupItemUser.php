 ...
 */
class GroupItemUser implements ArrayAccess
{
    /**
    ...
    static $ProfitBricksTypes = array(
        ...
        'type' => 'string',
        'href' => 'string',
        'items' => '\ProfitBricks\Client\Model\GroupItemUsers[]'
    );
    ...
    /**
      ...
      * @var \ProfitBricks\Client\Model\GroupItemUsers[]
      */
    protected $items;
    ...
    /**
     * Gets items
     * @return \ProfitBricks\Client\Model\GroupItemUsers[]
     */
    ...
    /**
     * Sets items
     * @param \ProfitBricks\Client\Model\GroupItemUsers[] $items Array of items in that collection
     * @return $this
     */
