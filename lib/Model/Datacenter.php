 ...
 */
class Datacenter implements ArrayAccess
{
    /**
    ...
    static $ProfitBricksTypes = array(
        ...
        'properties' => '\ProfitBricks\Client\Model\DatacenterProperties',
        'entities' => '\ProfitBricks\Client\Model\DatacenterEntities'
    );
