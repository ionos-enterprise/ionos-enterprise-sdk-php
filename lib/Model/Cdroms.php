 ...
 */
class Cdroms implements ArrayAccess
{
    /**
    ...
    static $ProfitBricksTypes = array(
        ...
        'type' => 'string',
        'href' => 'string',
        'items' => '\ProfitBricks\Client\Model\Image[]'
    );
    ...
    /**
      ...
      * @var \ProfitBricks\Client\Model\Image[]
      */
    protected $items;
    ...
    /**
     * Sets items
     * @param \ProfitBricks\Client\Model\Image[] $items Array of items in that collection
     * @return $this
     */
