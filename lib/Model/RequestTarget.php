...
use \ArrayAccess;
/**
 * RequestTarget Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     ProfitBricks\Client
 ...
 */
class RequestTarget implements ArrayAccess
{
    /**
    ...
    static $ProfitBricksTypes = array(
        'target' => '\ProfitBricks\Client\Model\ResourceReference',
        'status' => 'string'
    );
    ...
    /**
     * Sets target
     * @param \ProfitBricks\Client\Model\ResourceReference $target
     * @return $this
     */
