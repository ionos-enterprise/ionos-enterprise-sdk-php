...
use \ArrayAccess;
/**
 * FirewallRules Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     ProfitBricks\Client
 ...
 */
class FirewallRules implements ArrayAccess
{
    /**
    ...
    static $ProfitBricksTypes = array(
        ...
        'type' => 'string',
        'href' => 'string',
        'items' => '\ProfitBricks\Client\Model\FirewallRule[]'
    );
    ...
    /**
      ...
      * @var \ProfitBricks\Client\Model\FirewallRule[]
      */
    protected $items;
    ...
    /**
     * Sets items
     * @param \ProfitBricks\Client\Model\FirewallRule[] $items Array of items in that collection
     * @return $this
     */
