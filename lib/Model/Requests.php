 ...
 */
class Requests implements ArrayAccess
{
    /**
    ...
    static $ProfitBricksTypes = array(
        ...
        'type' => 'string',
        'href' => 'string',
        'items' => '\ProfitBricks\Client\Model\Request[]'
    );
    ...
    /**
      ...
      * @var \ProfitBricks\Client\Model\Request[]
      */
    protected $items;
    ...
    /**
     * Sets items
     * @param \ProfitBricks\Client\Model\Request[] $items Array of items in that collection
     * @return $this
     */
