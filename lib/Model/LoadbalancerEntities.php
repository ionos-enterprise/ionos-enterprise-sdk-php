...
use \ArrayAccess;
/**
 * LoadbalancerEntities Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     ProfitBricks\Client
 ...
 */
class LoadbalancerEntities implements ArrayAccess
{
    /**
    ...
    static $ProfitBricksTypes = array(
        'balancednics' => '\ProfitBricks\Client\Model\BalancedNics'
    );
    ...
    /**
      * $balancednics Collection of nics being balanced
      * @var \ProfitBricks\Client\Model\BalancedNics
      */
    protected $balancednics;
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            $this->balancednics = $data["balancednics"];
        }
    }
     ...
     */
    public function getBalancednics()
    {
    ...
    /**
     * Sets balancednics
     * @param \ProfitBricks\Client\Model\BalancedNics $balancednics Collection of nics being balanced
     * @return $this
     */
    public function setBalancednics($balancednics)
    {
