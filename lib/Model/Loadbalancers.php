...
use \ArrayAccess;
/**
 * Loadbalancers Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     ProfitBricks\Client
 ...
 */
class Loadbalancers implements ArrayAccess
{
    /**
    ...
    static $ProfitBricksTypes = array(
        ...
        'type' => 'string',
        'href' => 'string',
        'items' => '\ProfitBricks\Client\Model\Loadbalancer[]'
    );
    ...
    /**
      ...
      * @var \ProfitBricks\Client\Model\Loadbalancer[]
      */
    protected $items;
    ...
    /**
     * Sets items
     * @param \ProfitBricks\Client\Model\Loadbalancer[] $items Array of items in that collection
     * @return $this
     */
