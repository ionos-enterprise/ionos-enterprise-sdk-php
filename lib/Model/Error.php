...
class Error implements ArrayAccess
{
    ...
    static $ProfitBricksTypes = array(
        'http_status' => 'int',
        'messages' => '\ProfitBricks\Client\Model\ErrorMessage[]'
    );
    ...
    /**
      * $http_status HTTP status code of the operation
      * @var int
      */
    ...
    /**
      * $messages 
      * @var \ProfitBricks\Client\Model\ErrorMessage[]
      */
    protected $messages;
    ...
    /**
     * Sets http_status
     * @param int $http_status HTTP status code of the operation
     * @return $this
     */
    ...
    /**
     * Gets messages
     * @return \ProfitBricks\Client\Model\ErrorMessage[]
     */
    ...
    /**
     * Sets messages
     * @param \ProfitBricks\Client\Model\ErrorMessage[] $messages
     * @return $this
     */
