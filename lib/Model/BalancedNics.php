...
use \ArrayAccess;
/**
 * BalancedNics Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     ProfitBricks\Client
 ...
 */
class BalancedNics implements ArrayAccess
{
    /**
    ...
    static $ProfitBricksTypes = array(
        ...
        'type' => 'string',
        'href' => 'string',
        'items' => '\ProfitBricks\Client\Model\Nic[]'
    );
    ...
    /**
      ...
      * @var \ProfitBricks\Client\Model\Nic[]
      */
    protected $items;
    ...
    /**
     * Sets items
     * @param \ProfitBricks\Client\Model\Nic[] $items Array of items in that collection
     * @return $this
     */
