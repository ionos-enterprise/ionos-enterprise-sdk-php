 ...
 */
class Shares implements ArrayAccess
{
    /**
    ...
    static $ProfitBricksTypes = array(
        ...
        'type' => 'string',
        'href' => 'string',
        'items' => '\ProfitBricks\Client\Model\Share[]'
    );
    ...
    /**
      ...
      * @var \ProfitBricks\Client\Model\Share[]
      */
    protected $items;
    ...
    /**
     * Sets items
     * @param \ProfitBricks\Client\Model\Share[] $items Array of items in that collection
     * @return $this
     */
